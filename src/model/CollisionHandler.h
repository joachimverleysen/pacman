...
public:
    ...
    static bool checkCollision(const BoundingBox& first, const BoundingBox &second);
    static bool checkCollision(const BoundingBox& first, const BoundingBox &second, float margin);
