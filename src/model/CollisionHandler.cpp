...
bool CollisionHandler::checkCollision(const Entity *first, const Entity *second) {
    return checkCollision(first->getBoundingBox(), second->getBoundingBox());
}

bool CollisionHandler::checkCollision(const BoundingBox &first, const BoundingBox &second) {
...
bool CollisionHandler::checkCollision(const BoundingBox &first, const BoundingBox &second, float margin) {
    BoundingBox a = first;
